...
# sharpen and despur are optional features -- they default to False in
# fronts_from_gradb2, and configs A/B/C/Z do not declare them.
...
def config_filename(config_label: str, path:str=None):
    ...
    path : str, optional
        ...
        Defaults to ``front_finding/finding/configs/`` inside the installed package.
    ...
    """
    if path is None:
        path = os.path.join(resources.files('front_finding'), 'finding', 'configs')
