...
def prune_short_spurs(binary_image, Lspur:int=None):
    ...
    # skan builds a sparse graph from the skeleton; an empty one gives it
    # nothing to index and it fails deep in scipy.  An all-land or fully
    # ice-masked tile legitimately has no fronts.
